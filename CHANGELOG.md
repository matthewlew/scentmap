...
### Fixed
- **Accessibility** — Added `aria-label` attributes to global search, notes search, and universal search inputs matching their placeholder text to ensure accurate screen reader announcements.
