...
### Changed
- **Accessibility** — Added `aria-label` attributes to text inputs that previously relied solely on visual `placeholder` text (like `.input` and `.input--inline`), and ensured dynamic updates sync the ARIA label.
