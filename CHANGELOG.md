...
### Changed
- **Layering Transparency** — Updated the `scoreLayeringPair` engine function to return a detailed breakdown of the score (family, sillage, notes). Exposed this math in the UI under "Layer with what you own" to increase user trust and transparency.
