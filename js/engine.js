...
/**
 * Calculates similarity score details between two fragrances.
 */
export function getSimilarityDetails(a, b, FAM_COMPAT) {
  if (a.id === b.id) return { total: 0, famScore: 0, noteScore: 0, sillScore: 0, roleScore: 0 };
...
/**
 * Calculates a layering compatibility score details between two fragrances.
 */
