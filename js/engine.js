...
/**
 * Returns detailed mathematical breakdown of similarity between two fragrances.
 */
export function getSimilarityDetails(a, b, FAM_COMPAT) {
  if (a.id === b.id) {
    return { famScore: 40, noteScore: 30, sillScore: 10, roleScore: 20, total: 100 };
  }
...
/**
 * Returns detailed mathematical breakdown of layering compatibility between two fragrances.
 */
