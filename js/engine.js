...
/**
 * Calculates a similarity score (0-100) between two fragrances and returns breakdown.
 */
export function getSimilarityDetails(a, b, FAM_COMPAT) {
  ...
  const famScore = Math.round((FAM_COMPAT[a.family]?.[b.family] ?? 0.5) * 40);
  ...
  const total = famScore + noteScore + sillScore + roleScore;
...
/**
 * Calculates a layering compatibility score (0-100) between two fragrances and returns breakdown.
 */
