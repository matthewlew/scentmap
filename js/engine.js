...
/**
 * Calculates a similarity score breakdown between two fragrances.
 */
export function getSimilarityDetails(a, b, FAM_COMPAT) {
  ...
  return {
    ...
    total: Math.round(famScore + noteScore + sillScore + roleScore)
  };
}
...
/**
 * Calculates a layering compatibility score breakdown between two fragrances.
 */
