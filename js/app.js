        ...
        <div class="list-item-body">
          <div style="display:flex; justify-content:space-between; align-items:flex-start;">
            ...
            <div style="display:flex; gap:var(--sp-xs);">
              ...
              <button class="settings-btn" style="padding:4px;" aria-label="Delete review" onclick="deleteTrial('${t.id}', ${t.timestamp});">✕</button>
            </div>
          </div>
        </div>`;
...
function openUniversalSearch(opts = {}) {
  ...
  if (_usContext) {
    ...
    input.setAttribute('aria-label', 'Search fragrances, notes, and brands');
  }
