...
function openScoreEdu(type,matchPct,layerPct,fa,fb){
  ...
  let bodyContent = '';
  if (isMatch) {
    const { famScore, noteScore, sillScore, roleScore, total } = engine.getSimilarityDetails(fa, fb, store.FAM_COMPAT);
    ...
    bodyContent = `
      ...
      <div class="list-view">
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Family Match</div><div class="list-item-sublabel text-meta">${Math.round(famScore)}/40</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(famScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Shared Notes</div><div class="list-item-sublabel text-meta">${Math.round(noteScore)}/30</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(noteScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Sillage Match</div><div class="list-item-sublabel text-meta">${Math.round(sillScore)}/10</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(sillScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Role Overlap</div><div class="list-item-sublabel text-meta">${Math.round(roleScore)}/20</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(roleScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Raw Similarity Score</div><div class="list-item-sublabel text-meta">${total}/100</div></div><div class="list-item-trail"><span class="text-ui-strong">${total}</span></div></div>
      </div>
    `;
  } else {
    const { famScore, sillScore, noteScore, total } = engine.getLayeringDetails(fa, fb, store.FAM_COMPAT);
    ...
    bodyContent = `
      ...
      <div class="list-view">
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Family Compatibility</div><div class="list-item-sublabel text-meta">${Math.round(famScore)}/35</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(famScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Sillage Contrast</div><div class="list-item-sublabel text-meta">${Math.round(sillScore)}/20</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(sillScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Note Independence</div><div class="list-item-sublabel text-meta">${Math.round(noteScore)}/20</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(noteScore)}</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Raw Layering Score</div><div class="list-item-sublabel text-meta">${total}/75</div></div><div class="list-item-trail"><span class="text-ui-strong">${total}</span></div></div>
      </div>
    `;
  }
