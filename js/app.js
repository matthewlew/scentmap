      ...
      pairs.forEach(p => {
        ...
        card.innerHTML = `
          <div style="display:flex; justify-content:space-between; align-items:center;">
            ...
            <button class="settings-btn" style="padding:var(--sp-xs); opacity:0.6;" aria-label="Export recipe" onclick="event.stopPropagation(); window.exportLayeringRecipe('${p.a.id}', '${p.b.id}', ${p.score})">⤓</button>
          </div>
