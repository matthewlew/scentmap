...
function openScoreEdu(type,matchPct,layerPct,fa,fb){
  ...
  let bodyContent = '';
  if (isMatch) {
    const details = engine.getSimilarityDetails(fa, fb, store.FAM_COMPAT);
    ...
    bodyContent = `
      ...
      <div class="list-view">
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Family Match</div><div class="list-item-sublabel text-meta">${Math.round(details.famScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.famScore)}/40</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Shared Notes</div><div class="list-item-sublabel text-meta">${Math.round(details.noteScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.noteScore)}/30</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Sillage Match</div><div class="list-item-sublabel text-meta">${Math.round(details.sillScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.sillScore)}/10</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Role Overlap</div><div class="list-item-sublabel text-meta">${Math.round(details.roleScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.roleScore)}/20</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Raw Similarity Score</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.total)}/100</span></div></div>
      </div>
    `;
  } else {
    const details = engine.getLayeringDetails(fa, fb, store.FAM_COMPAT);
    ...
    bodyContent = `
      ...
      <div class="list-view">
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Family Compatibility</div><div class="list-item-sublabel text-meta">${Math.round(details.famScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.famScore)}/35</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Sillage Contrast</div><div class="list-item-sublabel text-meta">${Math.round(details.sillScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.sillScore)}/20</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Note Independence</div><div class="list-item-sublabel text-meta">${Math.round(details.noteScore)} points</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.noteScore)}/20</span></div></div>
        <div class="list-item"><div class="list-item-body"><div class="list-item-label text-ui-strong">Raw Layering Score</div></div><div class="list-item-trail"><span class="text-ui-strong">${Math.round(details.total)}/75</span></div></div>
      </div>
    `;
  }
