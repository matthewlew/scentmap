...
def main():
    with sync_playwright() as p:
        ...
        page.locator(".cmp-edu-body").evaluate("element => element.scrollTop = element.scrollHeight")
        page.wait_for_timeout(500)

        # Capture screenshot
        page.screenshot(path="verification/verification_bottom.png")
        ...
        # Capture screenshot
        page.screenshot(path="verification/verification_layering_bottom.png")
